...
| Commitments | `list_commitments`, `create_commitment`, `resolve_commitment`, `resolve_commitments` (batch, #159), `resolve_commitments_by_meeting` (delivery-event sweep, #159), `route_commitment` (off-project re-home, #159) |
...
That's the full surface — 39 tools. For per-verb signatures and usage
